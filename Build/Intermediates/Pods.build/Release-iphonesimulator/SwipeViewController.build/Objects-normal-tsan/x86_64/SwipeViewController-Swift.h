...
SWIFT_MODULE_NAMESPACE_PUSH("SwipeViewController")
@class UIScrollView;
@class UIViewController;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC19SwipeViewController19SwipeViewController")
@interface SwipeViewController : UINavigationController <UIPageViewControllerDelegate, UIScrollViewDelegate>
- (void)viewDidLoad;
...
@interface SwipeViewController (SWIFT_EXTENSION(SwipeViewController)) <UIPageViewControllerDataSource>
