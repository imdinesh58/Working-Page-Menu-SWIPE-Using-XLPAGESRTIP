...
SWIFT_CLASS("_TtC17CoreDataSampleApp26ChildExampleViewController")
@interface ChildExampleViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC17CoreDataSampleApp31TableChildExampleViewController")
@interface TableChildExampleViewController : UIViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface ViewController2 : ButtonBarPagerTabStripViewController
@property (nonatomic, readonly, strong) UIColor * _Nonnull blueInstagramColor SWIFT_DEPRECATED_OBJC("Swift property 'ViewController2.blueInstagramColor' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)viewDidLoad;
- (NSArray<UIViewController *> * _Nonnull)viewControllersFor:(PagerTabStripViewController * _Nonnull)pagerTabStripController SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'ViewController2.viewControllers(for:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
